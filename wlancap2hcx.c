...
printf("%s %s (C) %s ZeroBeat\n"
	...
	"-w <file> : output only forced from clients to hccapx file\n"
	"-W <file> : output only forced from access points to hccapx file\n"
	"-j <file> : output john WPAPSK-PMK file\n"
	"-J <file> : output only handshakes from clients to john WPAPSK-PMK file\n"
